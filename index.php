...
if($message == "/help"){
        send_message($chat_id, "Contact @ahm7d_dev");
    }
if($message == "/donate"){
        send_message($chat_id, "bitcoin: 1FDjCfLLb1fWCupkFDkoi3ffjjNrTgUzFS");
    }
...
// id == (admins user id)
if ($id == 1171876903 || $id == 1478297206 || $id == 1622998184 || $id == 638178378 ) {
...
$data = json_decode($result, true);
  ...
  if ($data != null) {
    ...
    function send_message($chat_id, $message){
        $apiToken =  "1634070175:AAHgVktMOU88nTzDgbcuh5Ibw5yob3rsc-4";
